...
const JoinUs = () => {
  ...
  return (
    <section
      id="career"
      className="relative max-w-screen-3xl mx-auto bg-[#081C26]  bg-cover bg-center bg-no-repeat join-us"
    >
      {/* <section
      id="career"
    ...
    > */}
      ...
      >
        ...
        <button
          type="submit"
          className="mt-8 sm:px-8 px-5 py-2 bg-primary text-white font-normal rounded"
        >
          {status === "sending"
            ? "Sending..."
            : status === "sent"
